...
import "./signup.css"
import { TextFieldExplained } from "../../component/indexp";
            ...
            <div className="container">
                ...
                method="post">
                    ...
                    <div className="singup-inputs-group">
                        <TextFieldExplained  name="firstName" type="text" variant="two" label="FirstName" />
                        <TextFieldExplained  name="lastName" type="text" variant="two" label="LaststName" />
                    </div>
                        <div className="email-pass">
                        <TextFieldExplained   name="email" type="email" variant="two" label="Emails" />
